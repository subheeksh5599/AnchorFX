...
export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL ?? "https://anchorfx.vercel.app";
export const CONTACT_EMAIL =
  process.env.NEXT_PUBLIC_CONTACT_EMAIL ?? "contact@anchorfx.dev";
export const GITHUB_REPO =
  process.env.NEXT_PUBLIC_GITHUB_REPO ??
  "https://github.com/subheeksh5599/AnchorFX";
...
export const CONTRACT_ID =
  ...
  "CDGQ7K4XGAPG3YJVAGHCE45XOR63HLD6ARJCRESEEKSRQZSIRAKG6F6V";
...
export const ORACLE_ID =
  process.env.NEXT_PUBLIC_ORACLE_ID ??
  "CCOIG4R7AIUQTP5CURK4PFINFF2EVQTBGTCN636E2JY25FGY7L4K54KT";
